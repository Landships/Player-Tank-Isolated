...
{
    public bool owner; // owner = player 2

    public GameObject left_crank;
    public GameObject right_crank;
    ...
    void update_world_state()
    {
        ...
        {
            left_crank.transform.localRotation = Quaternion.Euler(leftr_x, leftr_y, leftr_z);
            right_crank.transform.localRotation = Quaternion.Euler(rightr_x, rightr_y, rightr_z);
        }
    }
    ...
    public void server_get_values_to_send()
    {
        ...
        data_cache[index] = left_crank.transform.localRotation.x;
        data_cache[index + 1] = left_crank.transform.localRotation.y;
        data_cache[index + 2] = left_crank.transform.localRotation.z;
        data_cache[index + 3] = right_crank.transform.localRotation.x;
        data_cache[index + 4] = right_crank.transform.localRotation.y;
        data_cache[index + 5] = right_crank.transform.localRotation.z;
    ...
    void client_send_values()
    {
        ...
        client_cache[0] = left_crank.transform.localRotation.x;
        client_cache[1] = left_crank.transform.localRotation.y;
        client_cache[2] = left_crank.transform.localRotation.z;
        client_cache[3] = right_crank.transform.localRotation.x;
        client_cache[4] = right_crank.transform.localRotation.y;
        client_cache[5] = right_crank.transform.localRotation.z;
