...
public class Bullet_Generator_CS : NetworkBehaviour
{
    ...
    public GameObject Bullet_Object_PreFab;
    ...
    void Firing_Effects_AP()
    {
        if (MuzzleFire_Object)
        {
            ...
            Fire_Object.transform.parent = transform;
        }
    }
    [Client]
    void Firing_Effects_HE()
    {
...
//			return;
//		}
		Bullet_Object = (GameObject)Instantiate(Bullet_Object_PreFab);
		NetworkServer.Spawn(Bullet_Object);
        ...
        MeshFilter Temp_MeshFilter = Bullet_Object.GetComponent<MeshFilter>();
        BoxCollider Temp_BoxCollider = Bullet_Object.GetComponent<BoxCollider>();
        ...
        Temp_Rigidbody = Bullet_Object.GetComponent<Rigidbody>();
        Temp_Rigidbody.velocity = gameObject.transform.forward * Bullet_Force;

//		SetupScript setupScript = Bullet_Object.GetComponent<SetupScript> ();
//		setupScript.Bullet_Mesh = Bullet_Mesh;
//		setupScript.Bullet_Material = Bullet_Material;
//		setupScript.Bullet_Mass = Bullet_Mass;
//		setupScript.Bullet_Drag = Bullet_Drag;
//		setupScript.Bullet_PhysicMat = Bullet_PhysicMat;
//		setupScript.Bullet_Scale = Bullet_Scale;
//		setupScript.Bullet_Force = Bullet_Force;
//		setupScript.BoxCollider_Scale = BoxCollider_Scale;
//		setupScript.Delete_Time = Delete_Time;
//		setupScript.Impact_Object = Impact_Object;
//		setupScript.Ricochet_Object = Ricochet_Object;
//
		//setupScript.BulletSetup ();

		//Debug.Log(Bullet_Object.GetComponent<NetworkIdentity>());
		//NetworkInstanceId bulletID = Bullet_Object.GetComponent<NetworkIdentity> ().netId;
		//Debug.Log(bulletID);
		//Rpc_Set_AP(bulletID);
	...
	void Set_AP()
    {
        ...
        // Add Components
		//GameObject Bullet_Object = ClientScene.FindLocalObject(uniqueID);
...
//        Temp_Rigidbody = Bullet_Object.AddComponent<Rigidbody>();
